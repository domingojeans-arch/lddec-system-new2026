...
import { Search, Plus, Layers, Building2, CheckCircle2, Circle } from "lucide-react";
import { ScrollArea } from "@/components/ui/scroll-area";

interface LotManualSelectorProps {
  onSelect: (lot: EntryLot, entryId: string, entryNumber: string, clientId: string, clientName: string) => void;
  selectedLotId?: string;
}

export function LotManualSelector({ onSelect, selectedLotId }: LotManualSelectorProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="relative group">
        ...
        <Input 
          placeholder="Buscar lotes activos para manualidades..." 
          value={searchTerm}
