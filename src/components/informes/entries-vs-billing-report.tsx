    ...
    <div className="space-y-10 animate-in fade-in duration-500 print:m-0 print:p-0">
      <style jsx global>{`
        @media print {
          ...
          .header-logo { position: absolute; top: 1.2cm; right: 1.2cm; width: 2cm; height: 2cm; object-fit: contain; }
          ...
          table { border: 1.2pt solid black !important; border-collapse: collapse !important; width: 100% !important; }
