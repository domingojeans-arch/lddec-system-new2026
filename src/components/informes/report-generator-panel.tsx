    ...
    <div className="space-y-10">
      ...
      {reportGenerated && (
        <div className="animate-in slide-in-from-bottom-4 duration-500">
          ...
          {filters.type === "Informe de Ingresos vs. Facturación" && <EntriesVsBillingReport entries={reportData.entries} invoices={reportData.allInvoices || reportData.invoices} dateFrom={filters.dateFrom} dateTo={filters.dateTo} />}
