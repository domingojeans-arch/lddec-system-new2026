          ...
          <div className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <Select disabled={isReadOnly} value={formData.tipoPrenda} onValueChange={(val) => setFormData({...formData, tipoPrenda: val})}>
                ...
                <SelectContent><SelectItem value="Adulto">Adulto</SelectItem><SelectItem value="Niño">Niño</SelectItem></SelectContent>
              </Select>
            </div>
