  ...
  const faltantesData = useMemo(() => {
    ...
    entries.forEach(entry => {
      (entry.lotes || []).forEach((lote: any) => {
        // Excluir si ya está marcado como resuelto de novedad o si es falla de lavado o estado completado
        if (lote.isNoveltyResolved || lote.fallaLavado || lote.productionStatus === "Completed") {
          return;
        }
