...
const ALLOWED_ROLES = ["admin", "socio", "contador", "bodega", "facturacion", "chofer", "financiero", "banco", "produccion", "cobranzas", "operario_manualidades", "bodega_quimicos", "colaboradora"];
